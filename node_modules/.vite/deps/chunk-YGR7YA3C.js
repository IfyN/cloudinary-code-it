...
function createSourceFromModel(source2, transformationFromJson) {
  ...
  } else if (isIAudioSourceModel(source2)) {
    return AudioSource.fromJson(source2, transformationFromJson);
  } else {
...
//# sourceMappingURL=chunk-YGR7YA3C.js.map
